...
export class DataportKulturfinderApiModelDataWriteOpeningHoursMultiLingual {
    'id'?: number;
    ...
    static getAttributeTypeMap() {
        return DataportKulturfinderApiModelDataWriteOpeningHoursMultiLingual.attributeTypeMap;
    }
}
