...
export class DataportKulturfinderApiModelDataWriteCategoryMultiLingual {
    'id'?: number;
    ...
    static getAttributeTypeMap() {
        return DataportKulturfinderApiModelDataWriteCategoryMultiLingual.attributeTypeMap;
    }
}
